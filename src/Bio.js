         ...
         "ru": {
            ...
            "profileActivities": 
               <div className="ProfileActivities">
                  ...
                  <p><a href="/" onClick={this.props.onContactClick}>Напишите</a>, вдруг вашей идее тоже повезёт.</p>
         ...
         "en": {
            ...
            "profileActivities": 
               <p key="profile_activities">
                  ...
                  and <a href={links.noise}>making noise</a> on Tumblr. Feel free to <a href="/" onClick={this.props.onContactClick}>contact</a> me!
               </p>
            ,
            "inventory": "Inventory",
            "inventoryText": "Illustrator, Photoshop, Premiere, After Effects, Adobe XD, Sketch, Principle, Figma, Cinema 4D, Pixelmator Pro, Affinity Designer",
